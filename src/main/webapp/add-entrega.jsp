...
if (nombreUsuarioLogueado == null || rolUsuario == null) {
    ...
    background: #b3e5fc; /* Celeste claro */
       ...
       <h2>Añadir Entrega</h2>
            <form action="AddEntregaServlet" method="POST">
               ...
               <div class="form-group">
                <label for="fkIdMantenimiento">ID del Mantenimiento</label>
                <input type="number" class="form-control" id="fkIdMantenimiento" name="fkIdMantenimiento" 
                value="<%= request.getParameter("fkIdMantenimiento") %>" readonly>
            </div>
                <button type="submit" class="btn btn-primary">Añadir Entrega</button>
            </form>
    </div>
